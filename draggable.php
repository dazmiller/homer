        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="draggable.php">Draggable panels</a></li>
    ...
    <div class="normalheader">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>Example page for draggable panels</small>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        <div class="m-t-md m-b-md text-center">
                            <i class="fa fa-hand-o-up fa-4x"></i>
                            <div class="m-t">Drag and move panels.</div>
