...
<div class="hpanel forum-box">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-10 forum-heading">
                ...
                <a href="forum_details.php"><h4> General Discussion</h4></a>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <a href="forum_details.php" ><h4>Introductions</h4></a>
...
<div class="hpanel forum-box">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <span class="label label-warning pull-left">New</span>
                <a href="forum_details.php" ><h4>Quisque ultrices </h4></a>
...
<div class="hpanel forum-box">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <a href="forum_details.php" ><h4>Sed iaculis vel libero</h4></a>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                ...
                <a href="forum_details.php" ><h4>Mauris fermentum </h4></a>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <a href="forum_details.php" ><h4>Vivamus non lacus diam.</h4></a>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <a href="forum_details.php" ><h4>Donec lacus dolor</h4></a>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-10 forum-heading">
                <a href="forum_details.php" ><h4>Fusce sagittis</h4></a>
