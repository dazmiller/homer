...
<div class="normalheader transition animated fadeIn">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small>Clean invoice template.</small>
        </div>
    </div>
</div>
                ...
                <div class="panel-body p-xl">
                    <div class="row m-b-xl">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <address>
                                ...
                                <abbr title="Phone">P:</abbr> (831) 752-7000
                            </address>
                            <p>
                    ...
                    <div class="table-responsive m-t">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>
                                    <div><strong>Lorem Ipsum is that it has</strong></div>
                                    <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            ...
                            <tr>
                                <td>
                                    <div><strong>Has a more-or-less normal</strong></div>
                                    <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore magna aliqua.
                                    </small>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div><strong>That it has a more-or-less</strong></div>
                                    <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore magna aliqua.
                                    </small>
                                </td>
