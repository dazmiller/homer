        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="forms_extended.php">Forms extended</a></li>
    ...
    <div class="col-lg-12">
        <div class="hpanel">
            ...
            <p>
                ...
                http://bootstrap-datepicker.readthedocs.org/en/latest/index.php
            </p>
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <h5>Options</h5>
                                <p>
                                    There are many avalible options to datapicker, check: <a href="https://bootstrap-datepicker.readthedocs.org/en/latest/options.php" target="_blank">https://bootstrap-datepicker.readthedocs.org/en/latest/options.php</a>
                                </p>
                            </div>
