    ...
    <div class="small-header">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>Your personal profile.</small>
            </div>
        </div>
    </div>
                ...
                <div class="panel-body">
                    ...
                    <form name="simpleForm" novalidate id="simpleForm" action="#" method="post">
                        ...
                        <div class="text-center m-b-md" id="wizardControl">
                            ...
                            <a class="btn btn-primary" href="#step1" data-toggle="tab">Step 1 - User Data</a>
                            <a class="btn btn-default" href="#step2" data-toggle="tab">Step 2 - Personal/Family</a>
                            <a class="btn btn-default" href="#step3" data-toggle="tab">Step 3 - Occupation/Lifestyle</a>
                            <a class="btn btn-default" href="#step4" data-toggle="tab">Step 3 - Confirmation/Privacy</a>
                        </div>
                    ...
                    <div class="m-t-md">
                        ...
                        <p>
                           Sick of entering the same information again and again on site after site. Save yourself the time and energy by entering it just once here. Keep this information up to date and you will never have
                           to enter it again for any quote or request using nohassl.com
                        </p>
