        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="transition_one.php">Columns custom</a></li>
...
<div class="content">
<div class="row">
    <div class="col-lg-4 animate-panel"  data-child="hpanel" data-effect="fadeInLeft">
        <div class="hpanel">
    ...
    <div class="col-lg-4 animate-panel"  data-child="hpanel">
        <div class="hpanel">
            <div class="panel-heading">
                <div class="panel-tools">
                    <a class="showhide"><i class="fa fa-chevron-up"></i></a>
    ...
    <div class="col-lg-4 animate-panel"  data-child="hpanel" data-effect="fadeInRight">
        <div class="hpanel">
            <div class="panel-heading">
                <div class="panel-tools">
                    <a class="showhide"><i class="fa fa-chevron-up"></i></a>
