        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="modals.php">Modals</a></li>
        ...
        <div class="hpanel">
            ...
            <div class="panel-body">
                ...
                <div class="text-center m-b-md">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal5" href="dlg_profile.php" data-backdrop="static">
                        Large Modal
                    </button>
...
var modalInstance = $modal.open({
       templateUrl: 'views/modal/modal_example2.php',
...
<!-- Local style for fix body padding when modal is open -->
<!-- You can move it to main style.css -->
<style>
    body.modal-open {
