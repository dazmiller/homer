...
<div class="normalheader transition animated fadeIn">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small>Article board for blog page.</small>
        </div>
    </div>
</div>
...
<div class="col-md-3">
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Article about new design</h4></a>
            <p>
    ...
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Cras eleifend</h4></a>
            <p>
            ...
            <a href="blog_details.php" class="btn btn-primary btn-xs">Read more</a>
        </div>
        <div class="panel-footer">
                <span class="pull-right">
    ...
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Vivamus eu rutrum metus</h4></a>
            <p>
...
<div class="col-md-3">
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Many desktop publishing packages</h4></a>
            <p>
    ...
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Cras eleifend quam ipsum</h4></a>
            <p>
    ...
    <div class="hpanel blog-box">
        ...
        <div class="panel-image">
            ...
            <div class="title">
                <a href="blog_details.php"> <h4>Standard chunk of Lorem Ipsum</h4></a>
...
<div class="col-md-3">
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Latin professor at Hampden-Sydney College</h4></a>
            <p>
    ...
    <div class="hpanel blog-box">
        ...
        <div class="panel-body">
            <a href="blog_details.php"> <h4>Sed laoreet pulvinar mauris</h4></a>
            <p>
