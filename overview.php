    ...
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    <li class="active"><a href="overview.php"><span class="label label-success pull-right">Start</span> Overview </a>  </li>
...
&lt;/div&gt; </pre>
    ...
    <div class="col-lg-7">
        ...
        <div id="acontainer">
            <div class="runIt">
            <div class="row animate-panel setEffect"  data-effect="zoomIn" data-child="hpanel">
                <div class="col-lg-4" >
                    <div class="hpanel">
                        <div class="panel-heading">
                            <div class="panel-tools">
