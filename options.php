                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <dl class="dl-horizontal">
                                ...
                                <dd class="status-fixed-sidebar">Off</dd>

                                <dt style="text-align: left">Fixed navbar</dt>
                                <dd class="status-fixed-navbar">Off</dd>
    ...
    $(function () {
        ...
        $('#fixed-navbar').click(function(){
            if($('body').hasClass('fixed-navbar')) {
                ...
                $('.status-fixed-navbar').php("Off");

                if($('body').hasClass('fixed-sidebar')) {
                    $('body').removeClass('fixed-sidebar');
                    $('.status-fixed-sidebar').php("Off")
                }

                if($('body').hasClass('fixed-small-header')) {
                    $('body').removeClass('fixed-small-header');
                    $('.status-fixed-small-header').php("Off")
                }

            } else {
                $('body').addClass('fixed-navbar');
                $('.status-fixed-navbar').php("<span class='text-success font-bold'>On</span>");
            }
        });
        ...
        $('#fixed-sidebar').click(function(){
            ...
            if($('body').hasClass('fixed-sidebar')) {
                ...
                $('.status-fixed-navbar').php("<span class='text-success font-bold'>On</span>");
                $('.status-fixed-sidebar').php("<span class='text-success font-bold'>On</span>");
            }
        });
        ...
        $('#fixed-footer').click(function(){
            if($('body').hasClass('fixed-footer')) {
                ...
                $('.status-fixed-footer').php("Off");
            } else {
                $('body').addClass('fixed-footer');
                $('.status-fixed-footer').php("<span class='text-success font-bold'>On</span>");
            }
        });
        ...
        $('#fixed-small-header').click(function(){
            ...
            if($('body').hasClass('fixed-small-header')) {
                ...
                $('.status-fixed-navbar').php("<span class='text-success font-bold'>On</span>");
                $('.status-fixed-sidebar').php("<span class='text-success font-bold'>On</span>");
                $('.status-fixed-small-header').php("<span class='text-success font-bold'>On</span>");
            }
        });
