...
<html>
   <head>
      ...
      <link rel="stylesheet" href="vendor/sweetalert/lib/sweet-alert.css" />
        <link rel="stylesheet" href="vendor/imgrid/imgrid.css" />
      <!-- App styles -->
   ...
   <body>
      ...
      <div class="splash">
         ...
         <div class="splash-title">
            <h1>NoHassl.com</h1>
            <p>Time to take back your time and information. NoHassl.com takes all the worry and hassles out of finding the best quotes and deals for you. </p>
      ...
      <aside id="menu">
         <div id="navigation">
            ...
            <ul class="nav" id="side-menu">
               ...
               <li>
                  <a href="myprofile.php"> <span class="nav-label">Your Profile</span></a>
               </li>
               <li>
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               <div class="modal-header">
                  ...
                  <small class="font-bold">Sometimes the unexpected can happen. Be prepared for something that will happen to us all oneday. Ensure your family is protected for the future. </small>
               </div>
                           ...
                           <div class="row">
                              <div class="col-lg-3 text-center">
                                 ...
                                 <p class="small m-t-md">
                                    <strong>Personal Data</strong> is the information you have already entered in your profile. To save you typing it again and again we have pulled this data into the request for you.
                                    <br/><br/>Just check the information or enter any missing information and press the Next button to the right below.
                                 </p>
                              </div>
                              <div class="col-lg-9">
                                 <div class="row">
                        ...
                        <div id="step2life" class="p-m tab-pane">
                           <div class="row">
                              <div class="col-lg-3 text-center">
                                 ...
                                 <p class="small m-t-md">
                                    <strong>Insurance Questions</strong> are the common questions that all insurers will request. Just enter it once and we will send it to all the companies you choose.
                                    <br/><br/>You can always remove any data that you dont wish to share (unless its a required question, then you will have to enter the data sorry)
                                 </p>
                              </div>
                              <div class="col-lg-9">
                                 <div class="row">
                                    <div class="form-group col-lg-12">
                                       <label>Have you smoked tobacco or any other substance in the last 12 months?</label>
                                       <div class="radio">
                                          <div class="iradio_square-green " style="position: relative;"><input type="radio" name="Smoker" class="i-checks" style="position: absolute; opacity: 0;">
                                          </div>
                                          Yes </label>
                                          <div class="iradio_square-green " style="position: relative;"><input type="radio" name="Smoker" class="i-checks" style="position: absolute; opacity: 0;">
                                          </div>
                           ...
                           <div id="step3life" class="p-m tab-pane">
                           <div class="row">
                             <div class="col-lg-12">



<div class="imgrid-header"><span class="result"></span><a class="btn btn-xs btn-success unselect" style="display:none;float:right;">Unselect All</a><a class="btn btn-xs btn-success selectall" style="float:right;">Select All</a></div>
</div>
<div class="row">
<div class="col-lg-12">
<div id="imgrid" style="height:400px;overflow:auto;">
  <div class="image-selection" data-selection='multiple' data-image-size='medium' >
    <div class="gallery-item">
      <img src="images/lifeinsure/aia-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/asteron-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/bt-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/comminsure-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/macquarie-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/mlc-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/onepath-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/ozicare-small.jpg">
    </div>
    <div class="gallery-item">
      <img src="images/lifeinsure/zurich-small.jpg">
                           ...
                           <div class="text-right m-t-xs">
                              ...
                              <a class="btn btn-default next" href="#" id="lifenext3">Next</a>
                           </div>
                        </div>
                        <div id="step4life" class="tab-pane">
                           ...
                           <div class="text-right m-t-xs">
                              <a class="btn btn-default prev" href="#" id="lifeprev4">Previous</a>
                              <!--
      ...
      <script src="vendor/imgrid/imgrid.js"></script>
      <!-- App scripts -->
